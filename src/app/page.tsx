...
const user = {
  ...
  resume: "/resume-international.pdf",
  languages: [
    { name: "Français", level: "Natif" },
    { name: "Portugais", level: "Natif" },
    { name: "Anglais", level: "C1" },
    { name: "Espagnol", level: "C1" },
    { name: "Italien", level: "A2/B1" }
  ],
  social: {
  ...
  introduction: [
    ...
    "Je suis passioné par l'Intelligence Artificielle et me forme en continu pour rester à jour sur les dernières avancées dans ce domaine.",
    "Mes centres d'intérêt sont variés et incluent l'astronomie, l'aéronautique, le rugby, les mangas et le cinéma.",
  ],
  experience: [
    {
      title: "Data Analyst",
    ...
    },
    {
      ...
      tasks: [
        "Entraînement et fine-tuning de modèles CNNs, GANs et de Diffusion utilisant PyTorch pour la génération d'images photorealistiques",
        "Déploiement de modèles sur une interface utilisateur web Django",
      ]
    },
    {
      title: "Ripeur",
...
export default function Home() {
  ...
  return (
    <div className="flex">
      ...
      <main className="min-h-screen md:mt-20">
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1">
              ...
              >
                ...
                >
                  <h1 className="text-4xl font-bold font-display bg-gradient-to-r from-yellow-600 to-amber-600 dark:from-yellow-200 dark:to-amber-300 bg-clip-text text-transparent leading-tight py-2">
                    {user.name}
                  </h1>
                  <div className="flex items-center gap-4 mb-4 justify-center md:justify-start">
                    <h2 className="text-3xl font-medium text-[var(--neutral-600)] dark:text-[var(--neutral-400)] font-display">
                      {user.title}
                    </h2>
                  ...
                  >
                    {user.introduction.map((paragraph, index) => (
                      <p key={index} className="mb-1 text-m">
                        {paragraph}
                      </p>
                    ))}
                  </motion.section>
              ...
              <div className="space-y-8">
                ...
                >
                  <h2 className="text-2xl font-bold mb-6 font-display bg-gradient-to-r from-yellow-600 to-amber-600 dark:from-yellow-200 dark:to-amber-300 bg-clip-text text-transparent">
                    Traits de Personnalité
                  </h2>
                ...
                <motion.section
                  ...
                  className="bg-[var(--card)] rounded-lg shadow-md p-6 scroll-mt-20"
                >
                  <h2 className="text-2xl font-bold mb-3 font-display bg-gradient-to-r from-yellow-600 to-amber-600 dark:from-yellow-200 dark:to-amber-300  bg-clip-text text-transparent">
                    Expérience Professionnelle
                  </h2>
                  <div className="space-y-6">
                    {user.experience.map((exp, index) => (
                      ...
                      >
                        ...
                        <p className="text-m mb-2 text-[var(--neutral-600)] dark:text-[var(--neutral-400)]">{exp.period}</p>
                        <ul className="list-disc ml-4 space-y-1">
                          {exp.tasks.map((task, taskIndex) => (
                            <li key={taskIndex} className="text-m">{task}</li>
                          ))}
                        </ul>
                      </motion.div>
                    ))}
                ...
                <motion.section
                  ...
                  className="bg-[var(--card)] rounded-lg shadow-md p-6 scroll-mt-20"
                >
                  <h2 className="text-3xl font-bold mb-6 font-display bg-gradient-to-r from-yellow-600 to-amber-600 dark:from-yellow-200 dark:to-amber-300  bg-clip-text text-transparent">
                    Formation
                  </h2>
                  <div className="space-y-6">
