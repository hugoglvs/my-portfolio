...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    setUser({
      name: 'Invité',
      solvedPuzzles: solvedEvents.length,
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-8 text-white">
            <div className="flex items-center">
              ...
              <div className="ml-6">
                ...
                <p className="text-blue-100">Utilisateur Invité</p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-md shadow-sm">
                    <p className="text-gray-500 text-sm">Puzzles Résolus</p>
                    ...
                    user.achievements.map(achievement => (
                      <div key={achievement.id} className="bg-white p-4 rounded-md shadow-sm flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Débloqué le {achievement.date}</p>
                        </div>
                      </div>
                    ))
                  ) : (
                    <p className="text-gray-500 text-center">Aucun succès pour le moment. Commencez à explorer pour débloquer des succès !</p>
                  )}
                </div>
              </div>
            </div>
